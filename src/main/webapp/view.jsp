...
<form class="form-horizontal" method="post">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input class="form-control" id="category" name="category" value="${category.getName()}" disabled>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
<%--                <button class="button button" style="background-color: red">Yes</button>--%>
                <a href="product?action=edit&id=${product.getId()}" class="button button" style="background-color: #4CAF50">Edit</a>
                <a href="product?action=delete&id=${product.getId()}" class="button button" style="background-color: red">Delete</a>
